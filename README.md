...
Scripts using WES datasets were ran on Cardiff University's supercomputer 'HAWK' using the SLURM job schedular. 

Scripts using the 100kGP were ran on Genomics England's Double Helix supercomputer using IBM Load Sharing Facility.


## Repository Overview

| **Folder / File** | **Description** | **Tools used** | 
|------------------|-----------------|-------------------|
...
| `Chapter 7/` | Code and scripts related to Chapter 7 of the thesis. | Small variant workflow: https://re-docs.genomicsengland.co.uk/small_variant/, ggplot2 (R: v3.5.2).|
